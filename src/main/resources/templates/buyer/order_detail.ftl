        ...
        <div class="container">
            <div class="row clearfix">
                <div class="col-md-12 column">
                    <a href="/sell/buyer/manage" type="button" class="btn btn-default btn-info">返回</a>
                </div>
            </div>
            <div class="row clearfix">
                <div class="col-md-12 column">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12 column">
                            <#if orderDTO.getOrderStatusEnum().getCode() == 0>
                                <a href="/sell/buyer/order/cancel1?openid=${buyerId}&orderId=${orderDTO.orderId}" type="button" class="btn btn-default btn-danger">取消订单</a>
                            </#if>
                        </div>
                    </div>
                </div>
